            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-9">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('Dashboard_aboutUpdate') }}" method="post"
                            ...
                            @foreach ($about as $a)
                                <div class="card-body">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="file"
                                                    class="custom-file-input @error('file') is-invalid @enderror form-control"
                                                    id="exampleInputFile">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="degree" placeholder="{{ $a->degree }}"
                                            class="form-control @error('degree') is-invalid @enderror "> <br>
                                    </div>

                                    <div class="col-sm-12">
                                        <h4> message </h4>
                                        <textarea name="description" class="form-control w-100 p-2  @error('description') border border-danger @enderror" rows="5" cols="30"
                                            placeholder="{{ $a->brife_description }}"></textarea><br />
                                    </div>
