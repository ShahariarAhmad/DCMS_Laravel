...
@section('content')
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('Dashboard_uploadBlogPost') }}" method="post" class="row" enctype="multipart/form-data">
                <div class="col-xl-8 col-lg-8 bg-light p-5 shadow rounded">
                    @csrf
                    <input type="text" name="title"
                        class="w-100 p-3 mb-5  from-control @error('title') border border-danger @enderror"
                        placeholder="Enter blog title here...">


                    <textarea class="w-100 p-3 form-control  @error('title') border border-danger @enderror" name="article"
                    ...
                    <input type="submit" name="post" value="Post" class="btn btn-success px-5 py-2 float-right">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="row px-4">
                        ...
                        <div class="card @error('category') border border-danger @enderror">
